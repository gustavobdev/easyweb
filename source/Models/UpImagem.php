...
class UpImagem
{
    ...
    public function salvar($modelo, $campo, $variavel, $photo, $caminho, $file, $message, $atsessao)
    {
        ...
        $_SESSION["nome"] = $this->tirarAcento(($_SESSION['nome']));
        $_SESSION["sobrenome"] = $this->tirarAcento(($_SESSION['sobrenome']));
        ...
        $uploadfile = $caminho . $_SESSION["nome"] . '-' . $_SESSION["sobrenome"] . '.' . $tipo;
        ...
        // Se a imagem temporária não for movida para onde a variável com caminho e nome indica, exibiremos uma mensagem de erro
            ...
            if ($width_orig > $this->width || $height_orig > $this->height) {
                ...
                $this->redimensionar($caminho, $_SESSION["nome"] . '-' . $_SESSION["sobrenome"] . '.' . $tipo);
            } // -> fim if
            ...
            $model[0]->$photo = $caminho . $_SESSION["nome"] . '-' . $_SESSION["sobrenome"] . '.' . $tipo;
            $model[0]->save();
